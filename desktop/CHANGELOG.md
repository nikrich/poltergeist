...
* **api+desktop:** Capture sourceUrl + clickable activity rows ([9c13ff2](https://github.com/nikrich/poltergeist/commit/9c13ff2a6f080788a8676b3d3e3d829f69084952))
* **api+desktop:** Clickable "caught lately" captures on Today ([5808cb3](https://github.com/nikrich/poltergeist/commit/5808cb35bddf88d0e522ef06fe8c169379f4ccfb))
* **api+desktop:** Clickable past-meetings rows ([80fea6a](https://github.com/nikrich/poltergeist/commit/80fea6af2f968c620f0e3ec79842f47068139c95))
* **api+desktop:** Daily digest, semantic search, in-app markdown viewer ([9704b3f](https://github.com/nikrich/poltergeist/commit/9704b3f783902fae2af3db8ff03cb2e965c09650))
* **api+desktop:** RAG ask-the-archive with cited synthesized answers ([8e19967](https://github.com/nikrich/poltergeist/commit/8e19967130a62c021dcbf1ef412893f363e3f517))
* **api+desktop:** Setup screen + auto-record toggle ([a6ead24](https://github.com/nikrich/poltergeist/commit/a6ead24ebfb215e8b187f5a6f10d018b01b0d4a2))
* **api+desktop:** Start/stop manual recordings end-to-end ([21688c6](https://github.com/nikrich/poltergeist/commit/21688c6a8657818a3536c613f5d78c9db0787c4a))
...
* **chat:** Export-to-jots button with routed-destination toast ([fdb0b4d](https://github.com/nikrich/poltergeist/commit/fdb0b4dc1f0f85e418a6c7a9a6838ee1b65cb1db))
...
* **desktop:** Add Content-Security-Policy meta tag ([3d74901](https://github.com/nikrich/poltergeist/commit/3d74901f653ddac50c57ed850b11e834491409fd))
* **desktop:** Add icons for Microsoft connectors ([698fd1e](https://github.com/nikrich/poltergeist/commit/698fd1ededb06be76c7a447f4cb04a3b9f8c0355))
...
* **desktop:** App icon ([17f042d](https://github.com/nikrich/poltergeist/commit/17f042d2fe097d7a4518b9241cab09f0bd0e7164))
* **desktop:** Capture inbox screen + extract Catch component ([94aa178](https://github.com/nikrich/poltergeist/commit/94aa1781b84693bd85634532b48666680fb0b506))
* **desktop:** Capture screen reads from sidecar ([81de4db](https://github.com/nikrich/poltergeist/commit/81de4dbf6ebc781ea48bcf33d7e0ff76c493ac60))
* **desktop:** Connector logos for claude_code, jira, confluence, atlassian ([3e4cfa8](https://github.com/nikrich/poltergeist/commit/3e4cfa8d6502f31a419e71a62983197aa4d33dfd))
* **desktop:** Connectors screen — list + detail ([b36a33a](https://github.com/nikrich/poltergeist/commit/b36a33a38b46f952c9bddf27f722a2ff1046f0b5))
* **desktop:** Connectors screen reads from sidecar ([fc2cb7e](https://github.com/nikrich/poltergeist/commit/fc2cb7ea3d4e36d74a98ccff311ae99aa0fa0eb9))
...
* **desktop:** Density toggle has real visual effect ([3bc9b82](https://github.com/nikrich/poltergeist/commit/3bc9b822839c584371164cd4bf32d2bf56badbc0))
...
* **desktop:** ErrorBoundary wraps the App tree ([c1c6d1a](https://github.com/nikrich/poltergeist/commit/c1c6d1a8b0c7658eb74b18ad8c6e501464c08d4d))
* **desktop:** Extend [@theme](https://github.com/theme) tokens to cover design's full scale ([8765369](https://github.com/nikrich/poltergeist/commit/876536927565e39e927bb180faf06ca140555afb))
* **desktop:** Finalize Slice 1 — drop prototype, add README ([be830c4](https://github.com/nikrich/poltergeist/commit/be830c48e5f619949ff73468b0519f8f83dba949))
...
* **desktop:** HiddenInset window chrome on macOS ([a6144c4](https://github.com/nikrich/poltergeist/commit/a6144c4f4e094a93f57c3fb78a7c2a433b43239a))
...
* **desktop:** In-app scheduler with tray + background lifecycle ([7d8749a](https://github.com/nikrich/poltergeist/commit/7d8749ab0b1fc70555a8d78e57b944a4e1c83b0a))
...
* **desktop:** Kind-aware toasts (info/success/error) ([160feb1](https://github.com/nikrich/poltergeist/commit/160feb1fbee4d0756be7c4871655e6bd34324a10))
...
* **desktop:** Meetings history reads from sidecar ([33d4f50](https://github.com/nikrich/poltergeist/commit/33d4f50e8ae1e0e84c02b41e59edbe1565a43bcb))
* **desktop:** Meetings screen with pre/live/post state machine ([fb52a37](https://github.com/nikrich/poltergeist/commit/fb52a37645d88decf3f15d942919329864a59e5c))
* **desktop:** Native application menu ([4435168](https://github.com/nikrich/poltergeist/commit/44351682610464fa046933ca16194295338563e1))
* **desktop:** Open external markdown links in the browser ([3e7a455](https://github.com/nikrich/poltergeist/commit/3e7a4558b1ad2302139e1de4d5194067fa324c4e))
* **desktop:** Port shared primitives (Lucide, Ghost, Btn, Pill, Toggle, Panel, Eyebrow) ([a021c99](https://github.com/nikrich/poltergeist/commit/a021c99b1f1143152dbd495802374e5782ccbbcd))
...
* **desktop:** Re-enable renderer sandbox ([9ffd0e7](https://github.com/nikrich/poltergeist/commit/9ffd0e78710c406267f0214f59e3847e12cad6a3))
* **desktop:** React Query client + typed api wrapper ([a2e0c0a](https://github.com/nikrich/poltergeist/commit/a2e0c0aa9924bcb9e9dacd1b14c478927118f5f0))
* **desktop:** React query hooks per endpoint ([908c167](https://github.com/nikrich/poltergeist/commit/908c16759738ff15ad4c9e09d42b5b2a180fcc17))
...
* **desktop:** Scaffold electron-vite project, archive prototype ([96dd386](https://github.com/nikrich/poltergeist/commit/96dd3869bf85af3a8230c6977593e4c3b86b9096))
...
* **desktop:** Settings screen with persistent display/vault settings ([8b4bf3b](https://github.com/nikrich/poltergeist/commit/8b4bf3b238118ab5824af442376c73bcf1618bb0))
...
* **desktop:** Sidebar nav, top bar, status bar, toaster shell ([12bbba9](https://github.com/nikrich/poltergeist/commit/12bbba966fc92d9a7274bd51274617e939f607d0))
* **desktop:** Sidecar class for Python subprocess lifecycle ([edc81b1](https://github.com/nikrich/poltergeist/commit/edc81b120bd27de41cd53271d1c23c2fc6fe5313))
* **desktop:** Sidecar status store + setup screen ([503d34e](https://github.com/nikrich/poltergeist/commit/503d34efddb0c8aaae1a610055195b4bf96eaea8))
* **desktop:** SkeletonRows / PanelEmpty / PanelError primitives ([5a427dc](https://github.com/nikrich/poltergeist/commit/5a427dc94457b066798c956e67c3d77cb19ef48f))
* **desktop:** Spawn sidecar on app launch; wire api request IPC ([94880b8](https://github.com/nikrich/poltergeist/commit/94880b8307f42d6924ff1c18a8bf6fad2ba31d65))
* **desktop:** Tailwind v4 with design-token [@theme](https://github.com/theme) ([23d31e2](https://github.com/nikrich/poltergeist/commit/23d31e2cc032c576f4100345f36371004e4410a5))
...
* **desktop:** Toast feedback on sync, DevTools in View menu, audit log for in-app runs ([e1c012b](https://github.com/nikrich/poltergeist/commit/e1c012bee97647377432887fd3d747842a91d95b))
* **desktop:** Today screen — dashboard, agenda, activity, suggestions ([5b43999](https://github.com/nikrich/poltergeist/commit/5b4399913e7c458d578b602e6c99520f871ef23f))
* **desktop:** Today screen reads from sidecar ([3e17c54](https://github.com/nikrich/poltergeist/commit/3e17c5497f9cd1c69d76fc33fe9d1a46aaac7e4b))
* **desktop:** Typed api bridge + sidecar control + api-types ([036bbe5](https://github.com/nikrich/poltergeist/commit/036bbe5878116c4d0fee5215051ae6aeb5f052b7))
* **desktop:** Typed contextBridge + electron-store settings ([c933436](https://github.com/nikrich/poltergeist/commit/c9334368f69f89ebede1dc9f24f94b2cda2f05d7))
* **desktop:** Typed HTTP forwarder to the sidecar ([d331a80](https://github.com/nikrich/poltergeist/commit/d331a800b072206f8413e3b25d560b3826d69d2b))
* **desktop:** Typed mock data per screen ([e31f4d6](https://github.com/nikrich/poltergeist/commit/e31f4d65140cd139b951af282342d91b3006f45c))
...
* **desktop:** Validate IPC handler inputs with zod ([51d97ec](https://github.com/nikrich/poltergeist/commit/51d97ec729667a980dc3a2235a7020587f2706f3))
* **desktop:** Vault screen with real shell.openPath ([d8e4f2e](https://github.com/nikrich/poltergeist/commit/d8e4f2e65001c7842a7da7be581f1072474008b7))
* **desktop:** Vendor official brand svgs for connector icons ([61f4d10](https://github.com/nikrich/poltergeist/commit/61f4d109330cb302ff5c5858083351f31d3006d0))
...
* **desktop:** Window state persistence ([e6c40c9](https://github.com/nikrich/poltergeist/commit/e6c40c92970538f4feca86f7902ccf6f88658e03))
* **desktop:** Wire all settings toggles and selects to real persistence ([42ad3dd](https://github.com/nikrich/poltergeist/commit/42ad3dd064a9e577646e962a0fb8382d0c766367))
* **desktop:** Zustand stores (nav, settings, meeting, toast) ([5842754](https://github.com/nikrich/poltergeist/commit/584275436625b88e66c92b543ea4b848e0f222db))
* **digest:** Humanize slug filenames into readable titles + add --backfill ([0ab0897](https://github.com/nikrich/poltergeist/commit/0ab0897ab9f83f4cdcf2119589571ae9bd1184c1))
* **docs-assist:** Assist store + panel component ([c411e74](https://github.com/nikrich/poltergeist/commit/c411e7491406b746b097d7391c1034d5174816eb))
* **docs-assist:** Docs SSE relay + IPC bridge ([049f973](https://github.com/nikrich/poltergeist/commit/049f973b8d982483b2609a1489be41caa3f242bf))
* **docs-assist:** Editor imperative handle — selection, replace, html ([f781e28](https://github.com/nikrich/poltergeist/commit/f781e28953956a26c78165b1aba1e6f8db0ced29))
* **docs-assist:** Jots screen — assist panel, confluence export dialog, pdf download ([747b83a](https://github.com/nikrich/poltergeist/commit/747b83a01dc56b5f9cd47c04c1aaf6a905f677da))
* **docs-assist:** Pdf export via hidden window printToPDF ([efced02](https://github.com/nikrich/poltergeist/commit/efced026c53a4bbe9f9c288706bdec099cd6fc42))
* Dynamic projects + chat-summary export to jots ([19035de](https://github.com/nikrich/poltergeist/commit/19035de1bf0d9ff00ae8aa10f50fd23db0812a79))
...
* Jot docs assistant — vault-grounded writing + Confluence/PDF export ([fc12459](https://github.com/nikrich/poltergeist/commit/fc12459852b52306c2d3d784374ad3bb7c9ef6aa))
...
* **projects:** Desktop types + project/export hooks ([ad52a5a](https://github.com/nikrich/poltergeist/commit/ad52a5abb52542335dd23271bb999f7b65d43c77))
* **projects:** Jots re-route picker offers context/project destinations ([890ffac](https://github.com/nikrich/poltergeist/commit/890ffac65cc684c60dbd6b3072df511ab8f4d709))
* **projects:** Jots tree groups context → project → month ([a29f546](https://github.com/nikrich/poltergeist/commit/a29f546033909bdec3dd7d800da3cba292e38270))
* **projects:** Settings section — create/archive projects ([5efb175](https://github.com/nikrich/poltergeist/commit/5efb175b5db94e44c8c2ca3b11d032a502bfa6af))
...
* **scheduler:** Auto-restart crashed daemons with capped backoff ([477fabe](https://github.com/nikrich/poltergeist/commit/477fabeb2a07d5223c7b07f85d7f7191b8d570d4))
* **scheduler:** Register digest/claudemd/profile-weekly/profile-monthly + resilient worker ([0289280](https://github.com/nikrich/poltergeist/commit/02892804fc295734698e52e180b45084c10edeb7))
* **slack:** Full-pull mode with LLM keep/skip gate ([7a06117](https://github.com/nikrich/poltergeist/commit/7a06117eb064f6720b27c21e6abf1fb13df3e7b4))
...
* **api+desktop+gmail:** 404 capture detail, marketing leak, stub buttons ([4549321](https://github.com/nikrich/poltergeist/commit/454932106fe6eeff27db8c9b356aedb0baf31606))
* **api+desktop:** Connectors list empty in packaged builds + drop mock counters ([2243de9](https://github.com/nikrich/poltergeist/commit/2243de9ca028bef57e093d9f6b0c755dde71cac7))
* **api+desktop:** Repair agenda/captures/meetings against real disk layout ([fa75083](https://github.com/nikrich/poltergeist/commit/fa75083590edde146478fce96431c38ea4f39a90))
* **api+desktop:** Surface real captures + connectors that ran days ago ([58fd08c](https://github.com/nikrich/poltergeist/commit/58fd08c3e6f58974ac8336b1038dc61226c32e54))
* **build:** Add audio-input entitlement so the recorder can capture the mic ([6ace5c1](https://github.com/nikrich/poltergeist/commit/6ace5c10e14c311b60d5ff8c1907de808358bbba))
...
* **chat:** Export state survives navigation — store-backed, module-level export ([ed3b301](https://github.com/nikrich/poltergeist/commit/ed3b301b2a97ff2ac15e2141dd55a972348f04c0))
...
* **desktop:** Account section honest empty state ([4f04a9f](https://github.com/nikrich/poltergeist/commit/4f04a9f59ac805525d407956beb1ec5bcb27fd81))
...
* **desktop:** Add @testing-library/dom peer dep so vitest can resolve it ([b52c12e](https://github.com/nikrich/poltergeist/commit/b52c12e68c16c233a509673530d11258b0147db1))
* **desktop:** Align table headers with row data ([00cc384](https://github.com/nikrich/poltergeist/commit/00cc3840c5c782bf78c95a8ac08f96ce1adc0725))
* **desktop:** Bump api fetch timeout to 5m for LLM-bound endpoints ([9659219](https://github.com/nikrich/poltergeist/commit/9659219e282c771c12f19a01782757f76ec68006))
...
* **desktop:** Captures filter — abort in-flight on switch, drop background refetch ([95285cf](https://github.com/nikrich/poltergeist/commit/95285cf40ade7f86827bd35fdd7f1deaa79643ef))
* **desktop:** Center page content on wide screens ([406787f](https://github.com/nikrich/poltergeist/commit/406787f9fcd7f9da34c2e7aff9da34972b25af70))
...
* **desktop:** Introduce --neon-ink for readable neon-on-light text ([1aa5ae9](https://github.com/nikrich/poltergeist/commit/1aa5ae976f71fa1985d70a637015089754f7c46d))
* **desktop:** Make Obsidian wikilinks clickable in rendered markdown ([e199432](https://github.com/nikrich/poltergeist/commit/e199432b06b6f8e010e94777ba8daade4699bd80))
...
* **desktop:** Sidecar uses project venv python instead of PATH python3 ([94f8cd7](https://github.com/nikrich/poltergeist/commit/94f8cd732cc101d271d18bbdb2ec54aa4fb4baab))
* **desktop:** Surface recorder routing errors as a toast instead of "Uncaught (in promise)" ([657ff49](https://github.com/nikrich/poltergeist/commit/657ff49faa97d70190d81ef90ac1ecd6a7cbbb63))
* **desktop:** Theme switching — use [@theme](https://github.com/theme) inline to preserve runtime cascade ([28ec9fc](https://github.com/nikrich/poltergeist/commit/28ec9fc1a55f2a96bf1d549076c914a5fdeb06a0))
* **desktop:** Theme switching actually flips + readable neon on bone ([b2b322a](https://github.com/nikrich/poltergeist/commit/b2b322a53fdbc01739a97482a7bbf039d5408117))
* **desktop:** Widen ApiResult type to include status code ([832deb9](https://github.com/nikrich/poltergeist/commit/832deb9241e3a36c5d329d761718c2b26d5d4bea))
* **desktop:** Wire mark-all-read + real sidebar unread badge ([d6e91d5](https://github.com/nikrich/poltergeist/commit/d6e91d5ed20f45103c93464585e18ef396f4edca))
* **docs-assist:** Dialog escape key + force_new idiom + toast assertion ([361006b](https://github.com/nikrich/poltergeist/commit/361006bc39f2f1ce2b779a2480b7a02295f80f5d))
* **docs-assist:** Pdf export via temp file + validate export payload ([13f3835](https://github.com/nikrich/poltergeist/commit/13f3835e148da676845018a8f1b8a705bd44af78))
* **docs-assist:** Reset panel on jot switch in any active phase ([6a307bc](https://github.com/nikrich/poltergeist/commit/6a307bca1673336ddfd5b39d165aeb80060d4d66))
* **docs-assist:** User stop returns panel to idle, not error ([4a453d1](https://github.com/nikrich/poltergeist/commit/4a453d16dda7b077ece4c86a07b4612fe756763b))
...
* **llm:** Find claude binary when launched from Finder ([f7ea3ae](https://github.com/nikrich/poltergeist/commit/f7ea3aea4b46463647a8cb4ca81f94b2bb638efd))
...
* **recorder, api:** Output-device routing gate, transcript noise scrub, real indexed counts ([e2a683f](https://github.com/nikrich/poltergeist/commit/e2a683ffe1dc733d0ecce1a58c3f2e7ca24b9151))
* **recorder:** Restore transcription + release 0.3.0 ([fa3c25e](https://github.com/nikrich/poltergeist/commit/fa3c25e70d908b090f6ff214bc790d257bce4a88))
* **slack:** Log allowlist resolution path to a sentinel for diagnosis ([9dfa774](https://github.com/nikrich/poltergeist/commit/9dfa77465f3990599fea78498d978cea2507e5d2))
* **slack:** State-file allowlist + safe fallback when full-pull is misconfigured ([d8242d4](https://github.com/nikrich/poltergeist/commit/d8242d4b3cde9b0d45019ad282180635df7d6421))
* **slack:** Widen filter budget + pin LLM output to exact batch length ([c0f1bba](https://github.com/nikrich/poltergeist/commit/c0f1bba02a0d3a4d85d8f6a582d35be2bff3c977))
* **test:** Inject __APP_VERSION__ in vitest config too ([5041e5a](https://github.com/nikrich/poltergeist/commit/5041e5a376ab593e14d6492e5fdcb5ef6debcc4a))
