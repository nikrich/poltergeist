...
* fix(sidecar): child-process lifecycle discipline + persistent logs + pid-guarded descriptor cleanup (#112)
...
* fix(desktop): context dropdowns fetch from routing.yaml instead of hardcoded list (#107)
